...
for i in range(len(estimated_insurance_cost)):
    if estimated_insurance_cost[i] > insurance_cost[i]:
        insurance_cost_difference.append(estimated_insurance_cost[i] - insurance_cost[i])
    else:
        insurance_cost_difference.append(estimated_insurance_cost[i])

print("The difference is ",insurance_cost_difference)
